...
# note: zhenya2erin: I find it useful to run with `warning = TRUE` because some warnings are actually errors that don't stop the code from running. This can be done periodically instead of every time. Actually, I always use `warning=TRUE` and either deal with the warnings or silence them at the chunk level.
...
conceptual_plots<- cowplot::plot_grid(hereandnow_plot,temporality_props_plot,visual_plot,sensory_props_plot,cols = 2, rel_widths = c(1.5,2), labels = "AUTO")
