...
<!-- nitpick: zhenya2erin: AWC_check and compare_AWC sound like the same thing. I would use something like AWC_shapiro and AWC_paired_ttest. This applies to all the tests/summaries in the document. -->
...
<!-- issue: zhenya2erin: This needs to be a function. It is very hard to tell whether there are any difference in the plots. This goes for every chunk with plots in the document. -->
