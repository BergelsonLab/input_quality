...
[^2]: To make these measures more comparable, we present both in terms of words per hour.
...
This study, which contains more blind participants than prior research alongside a carefully peer-matched sighted sample, measured language input to young blind children and their sighted peers, using the LENA audio recorder. We found that along the quantity, interaction, and linguistic dimensions, parents talk similarly to blind and sighted children, with differences in conceptual content of the input. We discuss each of these results further below.
...
Our results uncover no systematic group differences in the quantity of speech, amount of language interaction, or linguistic complexity parents provide to blind vs. sighted children. When we do see differences, language input to blind children looks more conceptually complex. In other populations, complexity of this sort is linked with *more* sophisticated child language production, so it is not the case that blind children's language input is "impoverished".
...
In summary, our study compared language input in homes of 15 blind and 15 sighted infants. We found that both groups received similar quantities of adult speech, had similar levels of interaction, and heard input that was similarly linguistically complex. However, blind children were exposed to more language about not-currently-ongoing events, suggesting that they are being exposed to a rich linguistic environment that differs only modestly from the language input of sighted children. Our study does not imply that parents should change their communication styles, but rather highlights the language experiences of blind children. Future research should investigate how any input differences impact the language development and cognitive abilities of blind and sighted children alike.
