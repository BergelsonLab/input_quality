...
**Purpose:** This study compared language input to young blind children (N=15, 6--30mo., M:16mo.) and their demographically-matched sighted peers (N=15, 6--31mo., M:16mo.) in naturalistic home settings. By studying whether the language input of blind children differs from their sighted peers, we aimed to determine whether the language acquisition patterns observed in blind children could be explained by differences in their language input.

**Methods:** Using LENA audio recordings, naturalistic speech in the home was captured, transcribed, and analyzed for various dimensions of language input, including quantity, interaction (conversational turns and child-directed speech), linguistic properties (lexical diversity and mean length of utterance), and conceptual features (How much talk centered around the here-and-now? How much talk was about visual referents (that would be inaccessible to the blind children)?).

**Results:** Our data showed broad similarity across groups in speech quantity, interaction, and linguistic properties. Fine-grained analysis revealed that blind children's language environments contained significantly more talk about past/future/hypothetical events than sighted children's input.
...
<!-- * ec2eb:added some more specific info here. Don't want to get too in depth about blind adults' language, but I think this current para feels more balanced? -->
...
<!---ec2eb: final sentence is new. added since we're requesting Rana as a reviewer-->
...
# ec2eb: yes! checked, and that is indeed what *we* have access to, but I will do some more digging and see if I can get that info from more of our collaborators
...
With alllllll that said, if we do just raw TTR (which I think is a noisier measure), we get the same answer: no difference. Added that in a footnote, but please feel free to move or re-word. I don't know if Methods or Results is the right place for that-->
