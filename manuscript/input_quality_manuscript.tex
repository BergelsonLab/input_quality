...
Our corpus also revealed no significant difference in amount of interaction with the child, measured as the proportion of child-directed speech (\emph{t}(14) = 0.07, \emph{p} = .946) or in conversational turn counts to blind children versus to sighted children (\emph{W} = 61, \emph{p} = .978). Across both groups, child-directed speech constituted approximately 57\% of the input, and children were involved in roughly 17 conversational turns per hour.
...
\hline
Manual Word Count & Number of word tokens from speakers other than target child & Random & t-test & 2061, 2050, 602-3630 words/hour & 2313, 2170, 382-4178 words/hour & .387\\
\hline
Conversational Turn Count & Count of temporally close switches between adult and target-child vocalizations, divided by recording length & Whole day & Wilcoxon test & 33, 25, 13-90 turns/hour & 36, 32, 9-84 turns/hour & .946\\
\hline
...
\hline
Type-Token Ratio & Average of the type-token ratios (number of unique words divided by number of total words) for each of the 100-word bins in their sample & Random + High Volume & t-test & 0.65, 0.65, 0.6-0.67 words/hour & 0.63, 0.62, 0.55-0.69 words/hour & .058\\
\hline
