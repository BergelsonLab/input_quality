...
Previous research suggests that the makeup of language input (often referred to as input''quality'')\footnote{We avoid the term ``quality'' here as it carries potential biases regarding linguistic norms (MacLeod \& Demers, 2023).} is even more influential than quantity measures alone (Hirsh-Pasek et al., 2015; Rowe, 2012). Rowe and Snow (2020) categorized the makeup of the input along three dimensions: interactive features (e.g., parent responsiveness, speech directed \emph{to} child vs.~overheard, conversational turn-taking), linguistic features (e.g., lexical diversity, grammatical complexity), and conceptual features (i.e., the extent to which input focuses on the \emph{here-and-now}).
...
Our study assesses whether language input to blind children is different from the language input to sighted children, along the dimensions of quantity, interaction, linguistic properties, and conceptual properties. We test for group differences using paired t-tests or non-parametric Wilcoxon signed rank tests, when a Shapiro-Wilks test indicates that the variable is not normally distributed (summarized in Table \ref{tab:analysis-summary-table}). Because this analysis involves multiple tests against the null hypothesis (\emph{that there is no difference in the language input to blind vs.~sighted kids}), we use the Benjamini-Hochberg correction (Benjamini \& Hochberg, 1995) to control false discovery rate (Q = .05) for each set of analyses (quantity, interaction, linguistic, conceptual). Because each dimension's analysis consists of two statistical tests, our Benjamini-Hochberg critical values were \emph{p} \textless{} 0.025 for the smaller \emph{p} value and \emph{p} \textless{} 0.05 for the larger \emph{p} value. The results of these analyses are summarized in Table \ref{tab:analysis-summary-table}. For variables that did not differ significantly across groups, we additionally conducted equivalence tests against a small, moderate, and large effect sizes (Cohen's \emph{d} \textless{} \textbar0.3\textbar, \emph{d} \textless{} \textbar0.5\textbar, \emph{d} \textless{} \textbar0.7\textbar, respectively) to probe the reliability of our findings and evaluate the extent to which any observed lack of difference could be interpreted as equivalence.
...
## The null hypothesis test was non-significant, t(14) = -0.0202p = 0.98
## NHST: don't reject null significance hypothesis that the effect is equal to zero 
## TOST: don't reject null equivalence hypothesis
## 
## TOST Results 
##                   t df p.value
## t-test     -0.02022 14   0.984
## TOST Lower  1.14168 14   0.136
## TOST Upper -1.18211 14   0.128
## 
## Effect Sizes 
##                Estimate       SE                  C.I. Conf. Level
## Raw           -3.630515 179.5779 [-319.9229, 312.6619]         0.9
## Hedges's g(z) -0.004934   0.2582     [-0.4063, 0.3966]         0.9
...
##  Shapiro-Wilk normality test
## 
## data:  manual_word_tokens$MWC_per_hour
## W = 0.97972, p-value = 0.8181
\end{verbatim}
...
##  Paired t-test
## 
## data:  manual_word_tokens$MWC_per_hour by manual_word_tokens$group
## t = 1.06, df = 14, p-value = 0.3071
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -308.7752  912.2419
## sample estimates:
...
## Paired t-test
## 
## The equivalence test was non-significant, t(14) = -1.7, p = 0.06
## The null hypothesis test was non-significant, t(14) = 1.06p = 0.31
## NHST: don't reject null significance hypothesis that the effect is equal to zero 
## TOST: don't reject null equivalence hypothesis
## 
## TOST Results 
##                 t df p.value
## t-test      1.060 14   0.307
## TOST Lower  3.771 14   0.001
## TOST Upper -1.651 14   0.060
## 
## Effect Sizes 
##               Estimate       SE                  C.I. Conf. Level
## Raw           301.7333 284.6477 [-199.6195, 803.0862]         0.9
## Hedges's g(z)   0.2587   0.2634      [-0.155, 0.6635]         0.9
## Note: SMD confidence intervals are an approximation. See vignette("SMD_calcs").
\end{verbatim}
...
Our corpus also revealed no significant difference in amount of interaction with the child, measured as the proportion of child-directed speech (\emph{t}(14) = 0.24, \emph{p} = .811) or in conversational turn counts to blind children versus to sighted children (\emph{W} = 61, \emph{p} = .978). Across both groups, child-directed speech constituted approximately 56\% of the input, and children were involved in an estimated 34 conversational turns per hour (based on the LENA automated metric); see Figure \ref{fig:interaction-plots}. Here, both measures yielded significant equivalence tests, but only at the highest threshold (\emph{d}s \textless{} \textbar0.7\textbar).
...
Similarly, neither linguistic variable differed across groups: blind and sighted children's input had comparable type-token ratios (\emph{t}(14) = -0.96, \emph{p} = .353) and utterance lengths (\emph{t}(14) = -2.02, \emph{p} = .063). Children in our samples hear on average 64 unique words per hundred words and 5.20 morphemes per utterance; see Figure \ref{fig:linguistic-plots}. Here, neither variable provided evidence for equivalence at any effect size (all \emph{p}s \textgreater{} 0.5).
...
## The null hypothesis test was significant, t(14) = -2.68p = 0.02
## NHST: reject null significance hypothesis that the effect is equal to zero 
## TOST: reject null equivalence hypothesis
## 
## TOST Results 
##                  t df p.value
## t-test      -2.681 14   0.018
## TOST Lower  13.642 14 < 0.001
## TOST Upper -19.004 14 < 0.001
## 
## Effect Sizes 
##               Estimate      SE               C.I. Conf. Level
## Raw           -0.04927 0.01838 [-0.0816, -0.0169]         0.9
## Hedges's g(z) -0.65434 0.29003  [-1.0933, -0.195]         0.9
## Note: SMD confidence intervals are an approximation. See vignette("SMD_calcs").
\end{verbatim}
...
Lastly, we compared two measures of the conceptual features of language input: the proportion of temporally displaced verbs and the proportion of highly visual words; see Figure \ref{fig:conceptual-plots}. We found that blind children hear a higher proportion of displaced verbs than sighted children (\emph{t}(14) = -2.68, \emph{p} = .018), which on average equates to 22 more utterances about past, future, or hypothetical events per hour. We found no significant difference across groups in the proportion of highly visual words\footnote{And similarly, there were no significant group differences in the proportions of auditory words, tactile words, or non-visual-but-still-perceptual words.} (\emph{W} = 75, \emph{p} = .421), which constitute roughly 10\% of the input for both groups. For the visual words, equivalence testing was significant at the highest effect size (d \textless{} \textbar0.7\textbar).
...
## Age_months            13.96      14.34   0.974  0.33907   
## groupVI:Age_months   -31.85      20.22  -1.575  0.12736   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 451.6 on 26 degrees of freedom
## Multiple R-squared:  0.08842,    Adjusted R-squared:  -0.01676 
## F-statistic: 0.8407 on 3 and 26 DF,  p-value: 0.484
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = CTC_per_hour ~ group * Age_months, data = LENA_agediffs)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -32.386 -10.875  -4.126   7.462  45.940 
## 
## Coefficients:
##                    Estimate Std. Error t value Pr(>|t|)   
## (Intercept)          6.6676    10.3240   0.646  0.52404   
## groupVI             10.9180    14.4416   0.756  0.45644   
## Age_months           1.7793     0.5674   3.136  0.00422 **
## groupVI:Age_months  -0.8065     0.8002  -1.008  0.32279   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 17.87 on 26 degrees of freedom
## Multiple R-squared:  0.3326, Adjusted R-squared:  0.2556 
## F-statistic:  4.32 on 3 and 26 DF,  p-value: 0.01342
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = MWC_per_hour ~ group * Age_months, data = MWC_agediffs)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1919.3  -493.1  -149.3   660.8  1858.0 
## 
## Coefficients:
##                    Estimate Std. Error t value Pr(>|t|)    
## (Intercept)         2662.53     545.85   4.878 4.64e-05 ***
## groupVI             -753.27     763.56  -0.987    0.333    
## Age_months           -22.34      30.00  -0.745    0.463    
## groupVI:Age_months    27.86      42.31   0.659    0.516    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 944.9 on 26 degrees of freedom
## Multiple R-squared:  0.04948,    Adjusted R-squared:  -0.06019 
## F-statistic: 0.4512 on 3 and 26 DF,  p-value: 0.7186
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = prop_CDS ~ group * Age_months, data = xds_agediffs)
## 
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -0.40686 -0.08899  0.02787  0.11177  0.35602 
## 
## Coefficients:
##                     Estimate Std. Error t value Pr(>|t|)   
## (Intercept)         0.392309   0.107323   3.655  0.00114 **
## groupVI             0.047172   0.150129   0.314  0.75587   
## Age_months          0.010910   0.005899   1.850  0.07577 . 
## groupVI:Age_months -0.003744   0.008319  -0.450  0.65640   
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.1858 on 26 degrees of freedom
## Multiple R-squared:  0.1605, Adjusted R-squared:  0.06365 
## F-statistic: 1.657 on 3 and 26 DF,  p-value: 0.2006
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = mean_ttr ~ group * Age_months, data = TTR_agediffs)
## 
## Residuals:
##       Min        1Q    Median        3Q       Max 
## -0.079221 -0.017968 -0.002541  0.023193  0.059168 
## 
## Coefficients:
##                     Estimate Std. Error t value Pr(>|t|)    
## (Intercept)         0.604965   0.018305  33.049   <2e-16 ***
## groupVI             0.015523   0.025606   0.606    0.550    
## Age_months          0.001588   0.001006   1.579    0.127    
## groupVI:Age_months -0.000165   0.001419  -0.116    0.908    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.03169 on 26 degrees of freedom
## Multiple R-squared:  0.1785, Adjusted R-squared:  0.08375 
## F-statistic: 1.884 on 3 and 26 DF,  p-value: 0.1572
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = MLU ~ group * Age_months, data = MLU_agediffs)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.6413 -0.5029 -0.0158  0.5683  1.6428 
## 
## Coefficients:
##                      Estimate Std. Error t value Pr(>|t|)    
## (Intercept)         4.9886859  0.4810417  10.371 9.88e-11 ***
## groupVI            -0.0747382  0.6729033  -0.111    0.912    
## Age_months         -0.0009811  0.0264385  -0.037    0.971    
## groupVI:Age_months  0.0394126  0.0372860   1.057    0.300    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.8327 on 26 degrees of freedom
## Multiple R-squared:  0.1732, Adjusted R-squared:  0.07778 
## F-statistic: 1.815 on 3 and 26 DF,  p-value: 0.1691
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = prop ~ group * Age_months, data = temporality_agediffs)
## 
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -0.16022 -0.01600  0.01011  0.03109  0.09791 
## 
## Coefficients:
##                     Estimate Std. Error t value Pr(>|t|)    
## (Intercept)         0.316441   0.033513   9.442 6.91e-10 ***
## groupVI            -0.014165   0.046880  -0.302    0.765    
## Age_months         -0.001631   0.001842  -0.885    0.384    
## groupVI:Age_months  0.003948   0.002598   1.520    0.141    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.05801 on 26 degrees of freedom
## Multiple R-squared:  0.2307, Adjusted R-squared:  0.1419 
## F-statistic: 2.598 on 3 and 26 DF,  p-value: 0.07371
\end{verbatim}

\begin{verbatim}
## 
## Call:
## lm(formula = prop ~ Modality * group * Age_months, data = visual_agediffs)
## 
## Residuals:
##       Min        1Q    Median        3Q       Max 
## -0.112005 -0.004695 -0.000503  0.006234  0.106653 
## 
## Coefficients:
##                                           Estimate Std. Error t value Pr(>|t|)
## (Intercept)                               0.448045   0.019510  22.965  < 2e-16
## ModalityAuditory                         -0.393454   0.027591 -14.260  < 2e-16
## ModalityGustatory                        -0.447431   0.027591 -16.216  < 2e-16
## ModalityHaptic                           -0.447274   0.027591 -16.211  < 2e-16
## ModalityInteroceptive                    -0.444342   0.027591 -16.104  < 2e-16
## ModalityMultimodal                       -0.012717   0.027591  -0.461  0.64535
## ModalityOlfactory                        -0.446538   0.027591 -16.184  < 2e-16
## ModalityVisual                           -0.392602   0.027591 -14.229  < 2e-16
## groupVI                                  -0.026779   0.027291  -0.981  0.32763
## Age_months                               -0.003915   0.001072  -3.651  0.00033
## ModalityAuditory:groupVI                  0.050253   0.038596   1.302  0.19435
## ModalityGustatory:groupVI                 0.026553   0.038596   0.688  0.49223
## ModalityHaptic:groupVI                    0.029599   0.038596   0.767  0.44401
## ModalityInteroceptive:groupVI             0.028294   0.038596   0.733  0.46433
## ModalityMultimodal:groupVI                0.002205   0.038596   0.057  0.95449
## ModalityOlfactory:groupVI                 0.028313   0.038596   0.734  0.46403
## ModalityVisual:groupVI                    0.049010   0.038596   1.270  0.20556
## ModalityAuditory:Age_months               0.003564   0.001516   2.350  0.01971
## ModalityGustatory:Age_months              0.003905   0.001516   2.575  0.01072
## ModalityHaptic:Age_months                 0.004010   0.001516   2.645  0.00880
## ModalityInteroceptive:Age_months          0.003940   0.001516   2.598  0.01004
## ModalityMultimodal:Age_months             0.004764   0.001516   3.142  0.00192
## ModalityOlfactory:Age_months              0.003905   0.001516   2.575  0.01071
## ModalityVisual:Age_months                 0.007234   0.001516   4.770 3.46e-06
## groupVI:Age_months                        0.002642   0.001512   1.747  0.08206
## ModalityAuditory:groupVI:Age_months      -0.003587   0.002139  -1.677  0.09503
## ModalityGustatory:groupVI:Age_months     -0.002649   0.002139  -1.239  0.21690
## ModalityHaptic:groupVI:Age_months        -0.002690   0.002139  -1.258  0.20986
## ModalityInteroceptive:groupVI:Age_months -0.002706   0.002139  -1.265  0.20720
## ModalityMultimodal:groupVI:Age_months    -0.001990   0.002139  -0.930  0.35325
## ModalityOlfactory:groupVI:Age_months     -0.002674   0.002139  -1.250  0.21254
## ModalityVisual:groupVI:Age_months        -0.004843   0.002139  -2.265  0.02457
##                                             
## (Intercept)                              ***
## ModalityAuditory                         ***
## ModalityGustatory                        ***
## ModalityHaptic                           ***
## ModalityInteroceptive                    ***
## ModalityMultimodal                          
## ModalityOlfactory                        ***
## ModalityVisual                           ***
## groupVI                                     
## Age_months                               ***
## ModalityAuditory:groupVI                    
## ModalityGustatory:groupVI                   
## ModalityHaptic:groupVI                      
## ModalityInteroceptive:groupVI               
## ModalityMultimodal:groupVI                  
## ModalityOlfactory:groupVI                   
## ModalityVisual:groupVI                      
## ModalityAuditory:Age_months              *  
## ModalityGustatory:Age_months             *  
## ModalityHaptic:Age_months                ** 
## ModalityInteroceptive:Age_months         *  
## ModalityMultimodal:Age_months            ** 
## ModalityOlfactory:Age_months             *  
## ModalityVisual:Age_months                ***
## groupVI:Age_months                       .  
## ModalityAuditory:groupVI:Age_months      .  
## ModalityGustatory:groupVI:Age_months        
## ModalityHaptic:groupVI:Age_months           
## ModalityInteroceptive:groupVI:Age_months    
## ModalityMultimodal:groupVI:Age_months       
## ModalityOlfactory:groupVI:Age_months        
## ModalityVisual:groupVI:Age_months        *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.03377 on 208 degrees of freedom
## Multiple R-squared:  0.968,  Adjusted R-squared:  0.9632 
## F-statistic: 202.9 on 31 and 208 DF,  p-value: < 2.2e-16
\end{verbatim}
...
To show our cards, we are inclined towards option one: that blind children benefit from language input in the same ways as sighted peers (Landau \& Gleitman, 1985), and that this additionally extends to the benefits of receiving more conceptually complex language input. Language regularly supports learning in the absence of direct sensory perception (e.g., reading a book about mythical creatures). Given the language skills of blind adults (Loiotile et al., 2020; Röder et al., 2003; Röder et al., 2000), it is undeniable that language is a rich source of meaning for blind individuals as well (Lewis, Zettersten, \& Lupyan, 2019; van Paridon, Liu, \& Lupyan, 2021; \textbf{campbell2022?}). Testing each of these predictions--as well as whether links between language input and language outcomes change across developmental time--awaits further research.
