...
This study measured language input to young blind children and their sighted peers, using a 
to capture language input in the home. 
We found that across many dimensions of language input, parents largely talk similarly to blind and sighted children, with a few nuanced differences, that we discuss further below.
