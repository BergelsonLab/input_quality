...
VI_matches_demo <- VI_matches_demo %>%
  replace_na(list(MaternalEd = 'unknown')) %>%
 ...
 #MaternalEd = factor(MaternalEd, levels = c("unknown", "Some college", "Associate's degree",
...
make.table(
  ...
  caption = "Participant Demographics, by vision group",
  stripe.col   = "grey",
  output = "latex"
)
...
[a]Reminder to change Genia to Eugenia
