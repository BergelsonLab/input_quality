...
TD_wide_unfiltered <- pivot_wider(TD_single_column_with_names, names_from = "tier", values_from = "utterance") %>%
  ...
  TD_wide <- filter(TD_wide_unfiltered, !filename  %in% c("TD_419_961.eaf", "TD_420_268.eaf", "TD_421_536.eaf", "TD_422_217.eaf", "TD_424_676.eaf", "TD_431_248.eaf", "TD_426_429.eaf", "TD_423_184.eaf", "TD_430_493.eaf", "TD_425_194.eaf", "TD_433_522.eaf", "TD_429_190.eaf", "TD_437_564.eaf", "TD_428_188.eaf", "TD_438_522.eaf", "TD_439_192.eaf", "TD_442_763.eaf", "TD_440_189.eaf", "TD_451_521.eaf", "TD_450_183.eaf", "TD_453_998.eaf", "TD_452_277.eaf", "TD_457_475.eaf", "TD_459_188.eaf", "TD_462_513.eaf", "TD_461_190.eaf", "TD_468_758.eaf", "TD_455_248.eaf", "TD_441_732.eaf", "TD_434_249.eaf", "TD_457_475.eaf", "TD_459_188.eaf", "TD_435_205.eaf", "TD_454_510.eaf", "TD_469_748.eaf", "TD_470_759.eaf"))
```
...
ggplot(TD_CDS_proportion, aes(fill = xds, y=counts, x=filename)) +
  ...
  xlab("Recording") + ylab ("Proportion, by number of utterances") +
  scale_fill_discrete(labels=c('Adult-directed', 'Both child and adult', 'Child-directed', 'Other', 'Pet-directed', 'Unsure')) + theme(axis.text.x = element_text(face="bold", color="#000000", size=7, angle=45, vjust = 1))
...
MLU_plot <-
  ...
  geom_jitter(width = 0.2, height = 0) +
  theme_classic() +
  labs(y = "Average Mean Length of Utterance", x = NULL, element_text(size = 14)) +
  theme(
    legend.title = element_blank(),
    legend.position = "none",
    axis.text.x = element_text(angle = 45, hjust = 1)) +
  ...
  geom_linerange(aes(
    ...
    ymax = (mean(MLU_rough) - std.error(MLU_rough)))) +
  stat_summary(fun.data = "mean_cl_boot", color = 'black') +
  scale_x_discrete(
    labels = c(
      "1" = "Sighted",
  ...
  theme( axis.text = element_text(size = 14),
    ...
    strip.text.x = element_text(size = 14)) +
  labs(caption = "Average MLU from daylong audio recordings; each dot represents one speaker in a recording.\nData source: LENAs (VIHI, Seedlings, Warlaumont, & Cougar)") 
MLU_plot
```
```{r MLU-ttest}
