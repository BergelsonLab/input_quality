...
<!-- version where models are mentioned throughout: -->
...
```{r predicting-outcomes, include=FALSE}
...
<!-- version where models are only mentioned in the discussion:  -->
