...
<!-- lr: if language input is more adultlike, and theyre more delayed in getting semantic seed, maybe they're not yet able to take advantage of more complex input -->
<!-- ec: language input provides semantic seed but slower -->
