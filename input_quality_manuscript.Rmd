...
ggplot(CDS_proportion, aes(fill = xds, y=counts, x=VIHI_ID)) +
  ...
  scale_fill_discrete(labels=c('Adult-directed', 'Both child and adult', 'Child-directed', 'Other', 'Pet-directed', 'Unsure')) + theme(axis.text.x = element_text(face="bold", color="#000000", size=9, angle=90))
...
ggplot(all_proportion_table, aes(fill = xds, y= group_prop, x = group)) +
  ...
  xlab("Group") + ylab ("Proportion, by number of utterances") +
